 ...
 * @author    nicolaslopez82 - https://github.com/nicolaslopez82/
 * @license   GPL-2.0+
 * @copyright 2019 nicolaslopez82
 *
 * @wordpress-plugin
 * Plugin Name: Inhabitent Functionality
 * Description: Important plugin that contains core functionality for Inhabitent website so that it remains theme-independent.
 * Version:     1.0.0
